...
def process_table(table):
	...
	for j in range(1,numRows):
		...
		movie_details = [(date,month,year), movie[i].text, movie[i+1].text , movie[i+2].text, movie[i+3].text.split(',') ]
		#~ print movie_details
...
year = 2011
url= "file:///home/kapilg/letswatch/2011.html"
